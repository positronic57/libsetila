...
int SPI::spi_slave_read(SPI_Bus_Master_Device *spi_master, uint8_t registry,
...
int SPI::spi_slave_write_byte(SPI_Bus_Master_Device *spi_master,
...
int SPI::spi_slave_write_data(SPI_Bus_Master_Device *spi_master,
...
int SPI::spi_read_write_data(const SPI_Bus_Master_Device *spi_master,
  ...
  if (ioctl(spi_master->bus_master_fd(), SPI_IOC_MESSAGE(1), &spi_transfer) <
      0) {
