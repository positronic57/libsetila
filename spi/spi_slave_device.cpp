...
int SPI_Slave_Device::write_byte(uint8_t address, uint8_t value) { return 0; }

int SPI_Slave_Device::read_write(void *transmit_buffer, void *receive_buffer,
                                 int buffer_size) {
  ...
  return SPI::spi_read_write_data(m_bus_master, transmit_buffer, receive_buffer,
                                  buffer_size);
}
...
void SPI_Slave_Device::dettach_from_master_bus() { m_bus_master = nullptr; }
