...
int I2C::i2c_slave_read(int i2c_master, uint8_t i2c_slave_address,
...
int I2C::i2c_slave_write_byte(int i2c_master, uint8_t i2c_slave_address,
                              uint8_t registry, uint8_t value) {

  uint8_t write_buffer[] = {registry, value};
...
int I2C::i2c_slave_write_data(int i2c_master, uint8_t i2c_slave_address,
